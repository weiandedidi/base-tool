...
public class ColumnVO extends PropBaseVO {
    ...
    public static final String DB_INT_UNSIGNED = "INT UNSIGNED";
    public static final String DB_TINYINT = "TINYINT";
    public static final String DB_TINYINT_UNSIGNED = "TINYINT UNSIGNED";
    ...
    public static final String DB_BIGINT_UNSIGNED = "BIGINT UNSIGNED";
    ...
    public String getJavaType() {
        ...
        if (DB_TINYINT.equalsIgnoreCase(colType) || DB_TINYINT_UNSIGNED.equalsIgnoreCase(colType) || DB_SMALLINT.equalsIgnoreCase(colType)
                || DB_INT.equalsIgnoreCase(colType) || DB_INTEGER.equalsIgnoreCase(colType)) {
            if (getColumnDisSize() > 10) {
                javaType = JAVA_LONG;
            } else {
                javaType = JAVA_INT;
            }
        } else if (DB_BIGINT.equalsIgnoreCase(colType) ||  DB_INT_UNSIGNED.equalsIgnoreCase(colType) || DB_BIGINT_UNSIGNED.equalsIgnoreCase(colType)) {
            javaType = JAVA_LONG;
        } else if (DB_DECIMAL.equalsIgnoreCase(colType)) {
            javaType = JAVA_BIGDECIMAL;
        } else if (DB_NUMBER.equalsIgnoreCase(colType) || DB_NUMERIC.equalsIgnoreCase(colType)) {
